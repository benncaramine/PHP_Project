				...
				<div class="panel-body">
					...
					<form method="get" action="filieres.php" class="form-inline">
			            ...
			            <select name="niveau" class="form-control" id="niveau"
                            ...
                            <option value="TS"  <?php if($niveau==="1")  echo "selected" ?>>Téchnicien Spécialisé</option>
                            <option value="L"   <?php if($niveau==="2")   echo "selected" ?>>Licence</option>
                            <option value="M"   <?php if($niveau==="2")   echo "selected" ?>>Master</option>
                            <option value="CI"   <?php if($niveau==="2")   echo "selected" ?>>Cycle Ingénieur</option>
			            </select>
